...
import { powerBankProducts } from "./powerBankData";
    ...
    <div className="min-h-screen bg-[#FAEBD7] pt-28 px-4 sm:px-8 lg:px-14 pb-16">
      ...
      <div className="flex justify-between items-center mb-10">
        ...
        <p className="text-[#6b7f6d] italic text-sm sm:text-base">
          {powerBankProducts.length} items
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        {powerBankProducts.map((product) => (
          <div
            key={product.id}
            onClick={() => navigate(`/power-bank/${product.id}`)}
          ...
          >
            ...
            <div className="px-6 pb-6 pt-3 flex flex-col gap-3">
              ...
              <button
                ...
                text-white text-sm font-medium py-2.5 rounded-full
